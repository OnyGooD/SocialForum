      ...
      <div style={{
        ...
        <div style={{ flex: 1, maxWidth: 400, position: 'relative' }}>
          <span style={{
            ...
            color: '#6b6b78', fontSize: 14, pointerEvents: 'none',
          }}>🔍</span>
          <input
            type="text"
            value={query}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginLeft: 'auto', flexShrink: 0 }}>
          {user ? (
            <>
              <span style={{ fontSize: 13, color: '#6b6b78' }}>u/{user.username}</span>
              <button
                onClick={() => navigate('/create')}
                style={{
                  padding: '7px 16px', borderRadius: 8, fontSize: 14,
                  fontWeight: 500, background: '#ff4500', color: '#fff',
              ...
              <button
                ...
                style={{
                  padding: '7px 16px', borderRadius: 8, fontSize: 14,
                  fontWeight: 500, background: 'transparent', color: '#e8e8ec',
